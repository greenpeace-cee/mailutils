 ...
 * (GenCodeChecksum:5b3f54378283d0542bba27c69ac0e274)
 */
...
class CRM_Mailutils_DAO_MailutilsSetting extends CRM_Core_DAO {
  ...
  /**
   * Advanced Configuration Options as JSON
   *
   * @var string|null
   *   (SQL type: text)
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'advanced_config' => [
          ...
          'title' => E::ts('Advanced Configuration (JSON)'),
          'description' => E::ts('Advanced Configuration Options as JSON'),
          'where' => 'civicrm_mailutils_setting.advanced_config',
          'table_name' => 'civicrm_mailutils_setting',
          'entity' => 'MailutilsSetting',
          'bao' => 'CRM_Mailutils_DAO_MailutilsSetting',
          'localizable' => 0,
