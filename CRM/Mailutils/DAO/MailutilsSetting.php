 ...
 * (GenCodeChecksum:e26a4e2110a4fd4307f6d97a287b82fb)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => CRM_Mailutils_ExtensionUtil::ts('Unique MailutilsSetting ID'),
          'required' => TRUE,
        ...
        'mailutils_template_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_Mailutils_ExtensionUtil::ts('Mailutils Template ID'),
          'description' => CRM_Mailutils_ExtensionUtil::ts('Mailtuils Template for new messages'),
          'required' => FALSE,
        ...
        'smtp_server' => [
          ...
          'title' => CRM_Mailutils_ExtensionUtil::ts('SMTP Server'),
          'description' => CRM_Mailutils_ExtensionUtil::ts('SMTP Server'),
          'required' => FALSE,
          'maxlength' => 255,
        ...
        'smtp_port' => [
          'name' => 'smtp_port',
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_Mailutils_ExtensionUtil::ts('SMTP Port'),
          'description' => CRM_Mailutils_ExtensionUtil::ts('SMTP Port'),
          'required' => FALSE,
        ...
        'smtp_username' => [
          'name' => 'smtp_username',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Mailutils_ExtensionUtil::ts('SMTP Username'),
          'description' => CRM_Mailutils_ExtensionUtil::ts('SMTP Username'),
          'required' => FALSE,
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
        ...
        'smtp_password' => [
          'name' => 'smtp_password',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Mailutils_ExtensionUtil::ts('SMTP Password'),
          'description' => CRM_Mailutils_ExtensionUtil::ts('SMTP Password'),
          'required' => FALSE,
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
        ...
        'support_case_category_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_Mailutils_ExtensionUtil::ts('Support Case Category'),
          'description' => CRM_Mailutils_ExtensionUtil::ts('Support Case Category'),
          'required' => FALSE,
