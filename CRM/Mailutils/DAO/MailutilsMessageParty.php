 ...
 *
 * Generated from mailutils/xml/schema/CRM/Mailutils/005-MailutilsMessageParty.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:66e765ea52985ac81521e0d01a524032)
 */
...
class CRM_Mailutils_DAO_MailutilsMessageParty extends CRM_Core_DAO {
  ...
  public static function getEntityTitle($plural = FALSE) {
    return $plural ? E::ts('Mailutils Message Parties') : E::ts('Mailutils Message Party');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'title' => E::ts('ID'),
          'description' => E::ts('Unique MailutilsMessageParty ID'),
          'required' => TRUE,
        ...
        'mailutils_message_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => E::ts('Mailutils Message ID'),
          'description' => E::ts('FK to Mailutils Message'),
        ...
        'party_type_id' => [
          'name' => 'party_type_id',
          'type' => CRM_Utils_Type::T_INT,
          'title' => E::ts('Party Type'),
          'description' => E::ts('Message Party Type (From, To, CC, BCC)'),
          'required' => TRUE,
        ...
        'name' => [
          ...
          'title' => E::ts('Party Name'),
          'description' => E::ts('Party name'),
          'required' => FALSE,
          'maxlength' => 255,
        ...
        'email' => [
          'name' => 'email',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Party Email'),
          'description' => E::ts('Party email'),
          'required' => TRUE,
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
