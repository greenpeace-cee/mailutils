...
,          CONSTRAINT FK_civicrm_mailutils_setting_mail_setting_id FOREIGN KEY (`mail_setting_id`) REFERENCES `civicrm_mail_settings`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_mailutils_setting_mailutils_template_id FOREIGN KEY (`mailutils_template_id`) REFERENCES `civicrm_mailutils_template`(`id`) ON DELETE SET NULL  
)    ;
